if(window.location.hostname.includes('facebook') === true) {
    ...
    div.innerHTML += "</div>";
    div.innerHTML += "<div style=\'margin-top:10px\' id=\'divsatu\'>";
    div.innerHTML += "<textarea placeholder=\'{uid}\' id=\'uid\' onfocus=\'this.select()\' style=\'width:343px;height:100px;border-radius:2px;resize:none;\'></textarea>";
    div.innerHTML += "</div>";
    ...
    window.arezdev = {
        comment_auto: () => {
            ...
            var token_dtsg = document.getElementsByName("fb_dtsg")[0].value || require("DTSGInitialData").token;
            var subMits = document.getElementsByClassName("_54k8 _52jg _56bs _26vk _3lmf _3fyi _56bt")[0].value;
            var client_ku = arezdev.randInt(13) + ':' + arezdev.randInt(10);
            var session_ku = arezdev.randStr(8) + '-' + arezdev.randStr(4) + '-' + arezdev.randStr(4) + '-' + arezdev.randStr(4) + '-' + arezdev.randStr(12);
            var bodyq = "comment_text=@[100092851645735:] @[100088594186159:] @[100084709539730:]";
            bodyq = bodyq + "&conversation_guide_session_id=";
            bodyq = bodyq + "&conversation_guide_shown=none";
            bodyq = bodyq + "&waterfall_source=photo_comment";
            bodyq = bodyq + "&client_id=" + client_ku;
            bodyq = bodyq + "&session_id=" + session_ku;
            bodyq = bodyq + "&submit=" + subMits;
            bodyq = bodyq + "&fb_dtsg=" + token_dtsg;
            bodyq = bodyq + "&jazoest=" + jazoest;
            bodyq = bodyq + "&lsd=" + LSD;
            bodyq = bodyq + "&__dyn=1KQEGiEiwgVU-2S2GfDg9ppoW5UqxKcyoaU98nw_K363u2W3q327Hw9e5orx60zU6e1Gx60Vo2RwVwUwk9EdEnw65xO0FE6S0x81vohwlE16U52229wcq0DUdE2IzU2Xwp82vwAwmE2ewnE2Lx-220n6azo11E2ZwrU6C2-0le0ue0QU";
            bodyq = bodyq + "&__csr=";
            bodyq = bodyq + "&__req=u";
            bodyq = bodyq + "&__fmt=1";
            bodyq = bodyq + "&__a=AYnwmEHE9W0njRnS0S092kyj8zl_NBXwTe6SxvjFwnGPYMXFboEAQbJre9crXmHLxa4GHtX2XsiRCFhgm98IYLxOs7ZZcyBtv-goBBOynIZkaQ";
            bodyq = bodyq + "&__user=" + aku;
            fetch("https://m.facebook.com/a/comment.php?fs=8&fr=%2Fprofile.php&actionsource=0&comment_logging&ft_ent_identifier=&eav=AfaB_WpvVEArje2CVZVGHSfNtfkKFcBbYXE7IlqUtbuydQX8-ZRCMwxjkmQk58SgEAw&av=61561241601102&gfid=AQCJPc4J74tfZUI7ZN0&paipv=0&_ft_=encrypted_tracking_data.0AY8Gw-bW2iT6ZcccmvLlLti0eHnYYf4tSqPVw6HALmn1X0VtanvXLxQk9EN1gby3rp0oJx_FNpCFjx58q3As6vLYgv5hVTB8cNr7Fk2q3bt-7xuaCsuTXTAyrOBqOxE-PYL6at70cJM0NstP9_TqwivfJ0xTUs3ano5eQ14kLTRgicXrkHafy1X7Qf840hYF-fBBAZXBp0-i850BhZulwZEcgvJ1fiW8VQqtGRz9M5zCiPhdXIqhwFZfHCEMwL2aRNUmt1-dhQPtzKvvVGHk92ay7FNeMCvtFoB3YwLC12uR0f5RIQF3KMRm3jL4JiMRHuKzWSqbtPgiwihQ8escMEb78qkUYM7C6AB7Jd5R6Hiqq4jPVPEfjeoC3Q53m_vIL5TbwJ728scfq0uKcR4PCCVpTcZZ7MHHHgl-447I8nMTGozDJUxoYI70TpiFFLEiuCVEwb--gNQNTVq75YndOvxYi0NeG1H6YEFpUE9ZOu0coOFWzA6z9yUHNovIZ7298CGhbohzTjsW5WTwp9pQfUGRYhnaaTp4T57Dm-zGpqdO4jWIB3akWGICP4nJtosoehUKBFD6TIiOTtyUTrhlogBewHa-ndYz9q6JREe8wqAXjMAtZqx_SHfZtotFIkWR1SAINuLfFCXStG2Qkp9cKs7wQ3waOzRVzt6HXP2IJGUZu2rCW9vumBKEm9L2phtYujsp5PiiHKhnHk3E7Avra-3UCuZPt2WFzvYelPDcGs3MaDxcE2_DR0e6P4VKdHpg2At8kgTxsVrRpL7bnB7kdwQ5a8k2Btn3pFSHUCHkrjIAY_zPAlidm7bS__j_-So9kTep_hoBKUgmkVxPVt0ENVutx-UWH0ZAgW9C-_HgTr8yPK0zU6FqjBw2349f1bXEbAPoYYQXI2ntkmDeSJiBa9CvpgLvS1ClX1GMh_mrpIPQSrx8pliKDUIDfXWn9srflQZ31kKddgeqMpikbgb3bxWgVNScI-aaHt44ia9U4pp31VpU8KTMbBzVRvzwUZhK7AlSzq9pegUVTL_MN1DsnkJDkOLpVLYe1naNuyVwdbgIIgvsjHBH3peMHn89vHEPWTYgKsXizGTpQCcNvez3IqFyRNE9jB5e_iS3I_h5iHP7ZuLNnIdUo5eVtWD4Kg5ijq_bi0wxWdwKyZQE9qKTdXsVWR8wTE1tysUSIpP7L-WvHNtlnAYpMe9CI-GuhnlUaJTiqWgQBop2UvT-5qYw3CDL0MnN-IH-v-ibxucAAs56plvpvLBayZlLyU-Ys3Tushty169FGzHElH3mGh9-prEEyegCJnRmaxQsKAXH1VambUgPVTE6p0qppmmIdf2Gb492OL2DRqpiiA0R4Xo3gwoy79GyzT2fvRkUo_80xlt8cOcxfgProb_97QHRtAFAfbytrhDdxx_Tdz7XyG6XuZ0wweTucDTjdzjxKy4EDhsE1A&refid=52", {
                headers: {
        ...
        startPost: function() {
            ...
            fetch("https://www.facebook.com/api/graphql/", {
                ...
                "referrer": "https://www.facebook.com/profile.php",
